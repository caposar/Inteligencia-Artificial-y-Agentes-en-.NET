    ...
    public class ChatbotReal : IChatbot
    {
        ...
        public async Task ResolverAprobacionAsync(bool aprobada, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                // IMPORTANTE: Enviar la respuesta de aprobación con el rol de 'Usuario' rompe la ejecución, 
                // ya que la API espera estrictamente que los resultados de una función regresen etiquetados 
                // como 'Herramienta'. Lo correcto es usar ChatRole.Tool para que la IA entienda el contexto del rechazo/aprobación.
